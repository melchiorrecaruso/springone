...
uses
  ...
  athreads,
  {$ENDIF}
  Interfaces, Forms, ApplicationFrm, DrawingFrm, TextFrm,
  AboutFrm, GeometryFrmThree, MainFrm,
  MaterialFrm, ProductionFrm, QualityFrm, ReportFrm, LazControls, SysUtils,
  Composer, SpringLib;
