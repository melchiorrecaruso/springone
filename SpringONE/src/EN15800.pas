...
uses
  Classes, CsvDocument, Math, SysUtils, UtilsBase;

type
  TWireDiameterTolerance = class
  private
  ...
  private
    ...
    fWireDiameterTolerance: TWireDiameterTolerance;
  ...
  public
    ...
    property WireDiameterTolerance: TWireDiameterTolerance read fWireDiameterTolerance;
    ...
    property LoadF1: double write fLoadF1;
    property LoadF2: double write fLoadF2;
    property LengthL0: double write fLengthL0;
    property ActiveCoils: double write fActiveCoils;
    property DmQualityGrade: longint write fDmQualityGrade;
    property L0QualityGrade: longint write fL0QualityGrade;
    property F1QualityGrade: longint write fF1QualityGrade;
    property F2QualityGrade: longint write fF2QualityGrade;
    property E1QualityGrade: longint write fE1QualityGrade;
    property E2QualityGrade: longint write fE2QualityGrade;
...
var
   SpringTolerance: TSpringTolerance;
...
constructor TSpringTolerance.Create;
begin
  inherited Create;
  fWireDiameterTolerance := TWireDiameterTolerance.Create;
end;

destructor TSpringTolerance.Destroy;
begin
  fWireDiameterTolerance.Destroy;
  inherited Destroy;
end;

procedure TSpringTolerance.Clear;
begin
  fAD             := 0;
  fAF1            := 0;
  fAF2            := 0;
...
procedure TSpringTolerance.Solve;
var
  Index:  longint;
  Index1: longint;
  Index2: longint;
...
// TWireDiameterTolerance

constructor TWireDiameterTolerance.Create;
var
...
destructor TWireDiameterTolerance.Destroy;
begin
  fTolFile.Destroy;
  inherited Destroy;
end;

procedure TWireDiameterTolerance.Clear;
begin
  fValue := 0;
end;

function TWireDiameterTolerance.Search(const aID: string; const aWireDiameter: double): boolean;
var
  i: longint;
begin
  Clear;
...
initialization
begin
  SpringTolerance := TSpringTolerance.Create;
end;
